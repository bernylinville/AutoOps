...
type SysAdmin struct {
	...
	DingtalkUserID string     `gorm:"column:dingtalk_user_id;varchar(128);comment:'钉钉用户ID'" json:"dingtalkUserId"` // 钉钉用户ID
...
type JwtAdmin struct {
	...
	DingtalkUserID string `json:"dingtalkUserId"` // 钉钉用户ID
