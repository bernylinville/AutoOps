...
CREATE TABLE `cmdb_host` (
  ...
  `source_type` varchar(20) DEFAULT 'manual' COMMENT '数据来源(manual/aliyun/tencent/n9e)',
  `n9e_id` bigint DEFAULT NULL COMMENT 'N9E Target ID',
  `n9e_ident` varchar(128) DEFAULT NULL COMMENT 'N9E Target 标识',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `fk_cmdb_group_hosts` (`group_id`) USING BTREE,
  KEY `idx_cmdb_host_source_type` (`source_type`),
  KEY `idx_cmdb_host_n9e_ident` (`n9e_ident`),
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=264 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `n9e_config`
--

DROP TABLE IF EXISTS `n9e_config`;
CREATE TABLE `n9e_config` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `endpoint` varchar(500) NOT NULL,
  `token` varchar(500) NOT NULL,
  `timeout` int DEFAULT 30,
  `sync_cron` varchar(50) DEFAULT '',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='N9E 配置';

--
-- Table structure for table `n9e_sync_log`
--

DROP TABLE IF EXISTS `n9e_sync_log`;
CREATE TABLE `n9e_sync_log` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `n9e_busi_group`
--

DROP TABLE IF EXISTS `n9e_busi_group`;
CREATE TABLE `n9e_busi_group` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `n9e_group_id` bigint NOT NULL,
...
--
-- Table structure for table `n9e_datasource`
--

DROP TABLE IF EXISTS `n9e_datasource`;
CREATE TABLE `n9e_datasource` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `n9e_source_id` bigint NOT NULL,
  `name` varchar(200) NOT NULL,
